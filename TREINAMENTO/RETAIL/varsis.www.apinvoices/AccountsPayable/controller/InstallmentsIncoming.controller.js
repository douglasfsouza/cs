sap.ui.define([
	...
	return ListPageBase.extend(`${THIS_DOMAIN}.controller.InstallmentsIncoming`, {
		configurationFile: function() {
			return `${THIS_DOMAIN}/view/InstallmentsIncoming.view.json`;
		},
		...
		onRowNavigation: function(currentRow) {
			...
			oRouter.getTargets().display("installmentIncomingEdit",
			{
